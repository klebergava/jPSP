...
public final class GuiSingleton {
	...
	public static void showExportDB2Json() {
		if (exportDB2Json == null || !exportDB2Json.isVisible()) {
			exportDB2Json = new ExportDB2Json();
			exportDB2Json.createAndShow();
		} else {
			exportDB2Json.toFront();
		}
	}
