...
public class Strings {
	...
	public static final String VERSION = "1.0RC5";
	public static final String VERSION_DATE = "02/05/2024";
	...
	public static class DBOptions {
		...
		public static final String DEFAULT_FILE_NAME = "jpsp_db_export.csv";
	...
	public static class RestoreDB {
		...
		public static final String ATENTION = "ATENÇÃO! Faça backup do banco de dados antes de continuar.";
